...
This is a part 2 for introduction on inheritance::by Nyakama
Mahle
...
class and then in the derived  have also have function
...
If I have function person(string,string) in the base class
class and then in the  derived  alsohave the same
